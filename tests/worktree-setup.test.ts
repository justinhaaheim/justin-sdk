 ...
 * `--git-common-dir`), so mocking git would test nothing.
 *
 ...
 * .claude/worktrees on Justin's machine, and the .worktreeinclude tests turn on
 * exactly which files are gitignored — so without this they would pass or fail
